...
urlpatterns = patterns('',
    ...
    url(r'^archive/(?P<year>\d+)/(?P<month>\d+)/$', 'events.views.monthly_archive', name='monthly_archive'),
    url(r'^archive/$', 'events.views.archive', name='archive'),
    ...
    url(r'^xxxx/accounts/login/$', RedirectView.as_view(url=reverse_lazy('accounts_login'))),
    url(r'^xxxx/', include(application.urls)),
