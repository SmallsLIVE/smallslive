...
AWS_STORAGE_BUCKET_NAME_PHOTOS=os.environ.get('AWS_STORAGE_BUCKET_NAME_JAZZCULTURAL')

# Django storages / S3 / Smalls
AWS_ACCESS_KEY_ID_SMALLS = os.environ.get('AWS_ACCESS_KEY_ID_SMALLS')
AWS_SECRET_ACCESS_KEY_SMALLS = os.environ.get('AWS_SECRET_ACCESS_KEY_SMALLS')
AWS_STORAGE_BUCKET_NAME_SMALLS = os.environ.get('AWS_STORAGE_BUCKET_NAME_SMALLS')
...
STRIPE_PROFIT_CLIENT_ID_SMALLS = os.environ.get('STRIPE_PROFIT_CLIENT_ID_SMALLS')
STRIPE_PROFIT_CLIENT_SECRET_SMALLS = os.environ.get('STRIPE_PROFIT_CLIENT_SECRET_SMALLS')
