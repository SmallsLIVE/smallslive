...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'artists_artist_artist_type_many')
    ...
    def backwards(self, orm):
        # Removing M2M table for field artist_type_many on 'Artist'
        db.delete_table(db.shorten_name(u'artists_artist_artist_type_many'))
    ...
    models = {
        u'artists.artist': {
            ...
            'artist_type_many': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'artists'", 'symmetrical': 'False', 'to': u"orm['artists.ArtistType']"}),
