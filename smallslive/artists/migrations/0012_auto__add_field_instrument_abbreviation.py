...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instrument.abbreviation'
        db.add_column(u'artists_instrument', 'abbreviation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instrument.abbreviation'
        db.delete_column(u'artists_instrument', 'abbreviation')
