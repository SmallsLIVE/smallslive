...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding SortedM2M table for field instruments on 'Artist'
        db.create_table(u'artists_artist_instruments', (
        ...
        db.create_unique(u'artists_artist_instruments', ['artist_id', 'artisttype_id'])

    def backwards(self, orm):
        # Removing M2M table for field instruments on 'Artist'
        db.delete_table(db.shorten_name(u'artists_artist_instruments'))
    ...
    models = {
        u'artists.artist': {
            ...
            'instruments': ('sortedm2m.fields.SortedManyToManyField', [], {'to': u"orm['artists.ArtistType']", 'symmetrical': 'False', 'blank': 'True'}),
