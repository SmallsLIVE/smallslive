...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Artist.biography'
        db.alter_column(u'artists_artist', 'biography', self.gf('tinymce.models.HTMLField')())

    def backwards(self, orm):

        # Changing field 'Artist.biography'
        db.alter_column(u'artists_artist', 'biography', self.gf('django.db.models.fields.TextField')())
