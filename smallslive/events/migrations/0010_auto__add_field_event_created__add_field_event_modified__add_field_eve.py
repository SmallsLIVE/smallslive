...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_event', 'last_modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.SmallsUser'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'events_event', 'last_modified_by_id')
