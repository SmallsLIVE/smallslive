...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_set', (
            ('media_file', self.gf('django.db.models.fields.related.OneToOneField')(related_name='set', unique=True, primary_key=True, to=orm['multimedia.MediaFile'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sets', to=orm['events.Event'])),
            ('set_number', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'events', ['Set'])


    def backwards(self, orm):
        # Deleting model 'Set'
        db.delete_table(u'events_set')
    ...
    models = {
        ...
        u'events.set': {
            'Meta': {'ordering': "['set_number']", 'object_name': 'Set'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sets'", 'to': u"orm['events.Event']"}),
            'media_file': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'set'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['multimedia.MediaFile']"}),
            'set_number': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
