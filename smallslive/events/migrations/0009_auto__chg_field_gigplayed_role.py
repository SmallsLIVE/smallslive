...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('artists', '0011_auto__del_artisttype__add_instrument'),
    )

    def forwards(self, orm):

        # Changing field 'GigPlayed.role'
        db.alter_column(u'events_gigplayed', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['artists.Instrument']))

    def backwards(self, orm):

        # Changing field 'GigPlayed.role'
        db.alter_column(u'events_gigplayed', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['artists.ArtistType']))
