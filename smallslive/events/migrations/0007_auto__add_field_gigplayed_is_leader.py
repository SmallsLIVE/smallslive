...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GigPlayed.is_leader'
        db.add_column(u'events_gigplayed', 'is_leader',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GigPlayed.is_leader'
        db.delete_column(u'events_gigplayed', 'is_leader')
