...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.start_day'
        db.alter_column(u'events_event', 'start_day', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Event.end_day'
        db.alter_column(u'events_event', 'end_day', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.start_day'
        db.alter_column(u'events_event', 'start_day', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Event.end_day'
        db.alter_column(u'events_event', 'end_day', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        u'events.event': {
            ...
            'end_day': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'start_day': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
