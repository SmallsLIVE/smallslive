...
urlpatterns = [
    ...
    ## @TODO: Changed the supporter url path, as no supporter flow available now
    re_path(r'^supporterz/$', views.become_supporter, name='become_supporter'),
    ...
    ## @TODO: Changed the donate url path, as no donate flow available now
    re_path(r'^donatez/$', views.donate, name='donate'),
