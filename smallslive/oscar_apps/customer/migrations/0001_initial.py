    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(verbose_name='User', on_delete=models.SET_NULL,  related_name='emails', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.ForeignKey(related_name='notifications',  on_delete=models.SET_NULL, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(to='catalogue.Product',  on_delete=models.SET_NULL,)),
                ('user', models.ForeignKey(null=True, verbose_name='User',  on_delete=models.SET_NULL, related_name='alerts', to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
