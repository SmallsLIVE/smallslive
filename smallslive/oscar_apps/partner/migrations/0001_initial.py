    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(verbose_name='Country', on_delete=models.SET_NULL, to='address.Country')),
                ('partner', models.ForeignKey(verbose_name='Partner', on_delete=models.SET_NULL, related_name='addresses', to='partner.Partner')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner', models.ForeignKey(verbose_name='Partner', on_delete=models.SET_NULL, related_name='stockrecords', to='partner.Partner')),
                ('product', models.ForeignKey(verbose_name='Product', on_delete=models.SET_NULL, related_name='stockrecords', to='catalogue.Product')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='stockrecord',
            field=models.ForeignKey(verbose_name='Stock Record', on_delete=models.SET_NULL, related_name='alerts', to='partner.StockRecord'),
