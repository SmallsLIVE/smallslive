...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(model_name='stockrecord',name='price_excl_tax',field=models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name='Price'),),
