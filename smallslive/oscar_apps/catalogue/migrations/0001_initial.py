    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option_group', models.ForeignKey(null=True, on_delete=models.SET_NULL, verbose_name='Option Group', help_text='Select an option group if using type "Option"', to='catalogue.AttributeOptionGroup', blank=True)),
            ],
            options={
                'ordering': ['code'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ForeignKey(verbose_name='Attribute', on_delete=models.SET_NULL, to='catalogue.ProductAttribute')),
                ('entity_content_type', models.ForeignKey(null=True, on_delete=models.SET_NULL, editable=False, to='contenttypes.ContentType', blank=True)),
                ('product', models.ForeignKey(verbose_name='Product', on_delete=models.SET_NULL, related_name='attribute_values', to='catalogue.Product')),
                ('value_option', models.ForeignKey(null=True, on_delete=models.SET_NULL, verbose_name='Value option', to='catalogue.AttributeOption', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.ForeignKey(verbose_name='Category', on_delete=models.SET_NULL, to='catalogue.Category')),
                ('product', models.ForeignKey(verbose_name='Product', on_delete=models.SET_NULL, to='catalogue.Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='Date created')),
                ('product', models.ForeignKey(verbose_name='Product', on_delete=models.SET_NULL, related_name='images', to='catalogue.Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary', models.ForeignKey(verbose_name='Primary product', on_delete=models.SET_NULL, related_name='primary_recommendations', to='catalogue.Product')),
                ('recommendation', models.ForeignKey(verbose_name='Recommended product',on_delete=models.SET_NULL,  to='catalogue.Product')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='product_class',
            field=models.ForeignKey(null=True, on_delete=models.SET_NULL, verbose_name='Product type', related_name='attributes', to='catalogue.ProductClass', blank=True),
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(verbose_name='Group', on_delete=models.SET_NULL, related_name='options', to='catalogue.AttributeOptionGroup'),
            preserve_default=True,
        ),
    ]
