...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubscriptionFeature'
        db.create_table(u'subscription_subscriptionfeature', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feature', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subscription.Feature'])),
        ...
        db.send_create_signal(u'subscription', ['SubscriptionFeature'])

        # Adding model 'Feature'
        db.create_table(u'subscription_feature', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal(u'subscription', ['Feature'])

        # Adding field 'Subscription.best_choice'
        db.add_column(u'subscription_subscription', 'best_choice',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SubscriptionFeature'
        db.delete_table(u'subscription_subscriptionfeature')

        # Deleting model 'Feature'
        db.delete_table(u'subscription_feature')

        # Deleting field 'Subscription.best_choice'
        db.delete_column(u'subscription_subscription', 'best_choice')
