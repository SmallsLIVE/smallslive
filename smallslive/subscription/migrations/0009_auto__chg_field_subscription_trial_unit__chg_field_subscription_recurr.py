...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'subscription_subscription', 'trial_unit', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Subscription.recurrence_unit'
        db.alter_column(u'subscription_subscription', 'recurrence_unit', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

    def backwards(self, orm):

        # Changing field 'Subscription.trial_unit'
        db.alter_column(u'subscription_subscription', 'trial_unit', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

        # Changing field 'Subscription.recurrence_unit'
        db.alter_column(u'subscription_subscription', 'recurrence_unit', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    models = {
        ...
        u'subscription.expresstransaction': {
        ...
        u'subscription.subscription': {
            ...
            'trial_price': ('django.db.models.fields.DecimalField', [], {'max_digits': '64', 'decimal_places': '2'}),
