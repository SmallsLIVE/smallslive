...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.trial_price'
        db.add_column(u'subscription_subscription', 'trial_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=64, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.trial_price'
        db.delete_column(u'subscription_subscription', 'trial_price')
