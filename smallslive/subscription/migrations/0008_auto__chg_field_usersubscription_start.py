...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserSubscription.start'
        db.alter_column(u'subscription_usersubscription', 'start', self.gf('django.db.models.fields.DateField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'UserSubscription.start'
        db.alter_column(u'subscription_usersubscription', 'start', self.gf('django.db.models.fields.DateField')())
