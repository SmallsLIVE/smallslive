...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field permissions on 'Feature'
        db.delete_table(db.shorten_name(u'subscription_feature_permissions'))
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field permissions on 'Feature'
        m2m_table_name = db.shorten_name(u'subscription_feature_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('feature', models.ForeignKey(orm[u'subscription.feature'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(m2m_table_name, ['feature_id', 'permission_id'])
